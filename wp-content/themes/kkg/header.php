	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<a href="tel:+1<?php echo preg_replace("/[^0-9]/","",$et_phone_number);?>"><span id="et-info-phone"><?php echo et_sanitize_html_input_text( $et_phone_number ); ?></span></a>
				<?php endif; ?>

				<a href="tel:+18087252354"><span id="et-info-email">(808) 725-2354</span></a>
