...
final class WOOF {
	...
	$meta_query = $q->get('meta_query');
			//print "<pre>"; print_r($meta_query); print "</pre>"; die;
	//for extensions
	...
	//print "<pre>"; print_r($q->request); print "</pre>";
	return $q;
    }
...
//***
	...
	public function init_extensions() {
		...
		foreach ($directories['default'] as $path) {
		    ...
		    //if (in_array(md5($path), $activated))
		    if (WOOF_EXT::is_ext_activated($path)) {
			//print "<pre>"; print_r($path . DIRECTORY_SEPARATOR . 'index.php'); print "</pre>";	
			include_once $path . DIRECTORY_SEPARATOR . 'index.php';
		    }
		}
	    }
